  ...
  <div>
    <header>
      <div class="container text-center">
        <h1>ハロプロ 4 Answers Quiz 4択クイズ＆徹底解説</h1>
        <a href="/">
      ...
      <div class="container">
        <article class="col-md-8 col-xs-12">
          <section class="home-quiz__introduction">
            ...
            <p>4 Answers Quizとはハロプロに関する様々なクイズを4択で出題するWEBアプリです</p>
        ...
        <div class="col-md-4 col-xs-12">
          ...
          <section class="sidebar-sns-section">
            ...
            <div class="sidebar-sns-links">
              ...
              <ShareNetwork network="facebook" url="https://news.vuejs.org/issues/180" title="Shareボタン">
              ...
              <ShareNetwork network="googleplus" url title="Shareボタン">
